...
*/
public class WikiInputFormat extends TextInputFormat {
  ...
  public RecordReader<LongWritable,Text> getRecordReader(InputSplit inputSplit,
    ...
    return new WikiRecordReader((FileSplit) inputSplit, jobConf);
  }
...
*
*/
  public static class WikiRecordReader implements RecordReader<LongWritable,Text> {
